...
def main(api_endpoint, credentials, project_id,
    ...
    prog_dir  = '/home/pi/AIY-projects-python/src/robot/'
    image_dir = prog_dir + 'image/'
    def camera():
      now = datetime.now()
    ...
    def picamera(number, cameraKey):
      ...
      if cameraKey: # in ('picture', 'camera', 'photo'):
        fname = camera()
        result = os.system('python3 ' + prog_dir + 'visiontalk.py face ' + fname)
    ...
    def pimotor(number, directionKey):
      ...
      result = os.system('python ' + prog_dir + 'motor.py 100 3')
